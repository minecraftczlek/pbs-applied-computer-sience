...
public class ProjektRestControllerTest {
        ...
        public void getProjekty() throws Exception {
            Projekt projekt = new Projekt(1, "Nazwa1", "Opis1", LocalDateTime.now(), LocalDate.of(2020, 6, 7).atStartOfDay());
        ...
        public void getProjekt() throws Exception {
            Projekt projekt = new Projekt(2, "Nazwa2", "Opis2", LocalDateTime.now(), LocalDate.of(2020, 6, 7).atStartOfDay());
        ...
        public void createProjekt() throws Exception {
            Projekt projekt = new Projekt(null, "Nazwa3", "Opis3", null, LocalDate.of(2020, 6, 7).atStartOfDay());
            String jsonProjekt = jacksonTester.write(projekt).getJson();
            projekt.setProjektId(3);
            when(mockProjektService.createProjekt(any(Projekt.class))).thenReturn(projekt);
        ...
        public void createProjektEmptyName() throws Exception {
            Projekt projekt = new Projekt(null, "", "Opis4", null, LocalDate.of(2020, 6, 7).atStartOfDay());
            ...
            verify(mockProjektService, times(0)).createProjekt(any(Projekt.class));
        ...
        public void updateProjekt() throws Exception {
            Projekt projekt = new Projekt(5, "Nazwa5", "Opis5", LocalDateTime.now(), LocalDate.of(2020, 6, 7).atStartOfDay());
            String jsonProjekt = jacksonTester.write(projekt).getJson();
            ...
            verify(mockProjektService, times(1)).getProjekt(projekt.getProjektId());
            verify(mockProjektService, times(1)).createProjekt(any(Projekt.class));
            verifyNoMoreInteractions(mockProjektService);
        }*/
        /**
